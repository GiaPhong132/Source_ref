				...
				<div class="row">
					...
					<div class="col-md-6" data-aos="fade-left"  data-aos-duration="2500">
						...
						<div class="about-slider owl-carousel owl-theme">
							<!-- Story Image -->
							<div class="item">
								<img src="/Source_ref/public2/images/clion.png" alt="slider-image">
							</div>
							<!-- Story Image -->
							<div class="item">
								<img src="/Source_ref/public2/images/clion.png" alt="slider-image">
				...
				<div class="row">
					...
					<div class="col-lg-4 col-md-6">
						<div class="block text-center">
							...
							<div class="image shadow hover-zoom">
								<img src="/Source_ref/public2/images/visual.png" alt="investor">
							</div>
							<!-- Company -->
							<h3>Visual Studio</h3>
							<!--  -->
					...
					<div class="col-lg-4 col-md-6">
						<div class="block text-center">
							<!-- Investor Image -->
							<div class="image shadow hover-zoom">
								<img src="/Source_ref/public2/images/dietvirus.jfif" alt="investor">
							</div>
							<!-- Company -->
							<h3>Bảo mật</h3>
							<!--  -->
					...
					<div class="col-lg-4 col-md-6">
						<div class="block text-center">
							<!-- Investor Image -->
							<div class="image shadow hover-zoom">
								<img src="/Source_ref/public2/images/cloud.jfif" alt="investor">
							</div>
							<!-- Company -->
